...
import { LeaveTypeDto } from '../../models/hrms.models';
...
export class LeaveTypeListComponent implements OnInit {
  ...
  readonly rows = signal<LeaveTypeDto[]>([]);
  ...
  load(): void {
    ...
    this.api.getLeaveTypes().subscribe({
      ...
      error: (error) => {
        this.rows.set([]);
        this.errorMessage.set(extractApiErrorMessage(error, 'Unable to load leave types.'));
        this.loading.set(false);
      }
    });
  }
